...
public final class ServerMenuClient {
    ...
    private static boolean screenRead(JsonObject packet){String action=Json.opt(packet,"action","");return action.equals("community")&&java.util.Set.of("list","detail").contains(Json.opt(packet,"op",""))||java.util.Set.of("players","reports","myReports","myReport","history","menuData").contains(action);}
