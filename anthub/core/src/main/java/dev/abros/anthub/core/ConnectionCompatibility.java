...
public final class ConnectionCompatibility {
    ...
    public static final Set<String> FEATURES=Set.of("menu","auth","pack","home","players","board","groups","events","polls","ideas","notifications","info","help","admin","player-statistics","admin-tools","moderation-votes");
